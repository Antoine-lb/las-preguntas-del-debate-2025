		...
		<div class="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
			...
			<div class="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-lg p-8 border border-gray-100">
				...
				<div class="space-y-4">
					...
					<div class="flex justify-between items-start p-3 bg-white rounded-lg border border-gray-100">
						<span class="text-gray-600 font-medium flex-shrink-0 mr-4">Fuente:</span>
						<span class="font-semibold text-gray-900 text-right">{wordcloudData.metadata.source}</span>
					</div>
					<div class="flex justify-between items-center p-3 bg-white rounded-lg border border-gray-100">
